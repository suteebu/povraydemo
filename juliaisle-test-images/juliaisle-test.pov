...
camera {
	up <0,1,0>
	right <1,0,0>
	location <-0.046018,0.2500001,0.300010>
	look_at  <-0.046018,0.0000000,0.300010>
	angle 20
}

object {
     sphere {
                 <-0.046018,0.250000,0.300010> // center of sphere <X Y Z>
         0.00001       // radius of sphere
        texture{
           pigment{ Red }
        }
     }  
...
plane { y, 0.248
      texture{ pigment { checker color White color Red } scale 0.00002 }
}
...
#declare MyOrigin = object {
     sphere {
         <0, 0.25, 0> // center of sphere <X Y Z>
         0.0001       // radius of sphere
        texture{
           pigment{Black}
        }
     }  
...
#declare MyTarget = object {
     sphere {
         <0.0018, 0.25001, 0.0025> // center of sphere <X Y Z>
         0.000001       // radius of sphere
        texture{
           pigment{ Red }
        }
     }  
...
//---------------------------------------------                                
// X-axis pointer:
#declare MyXPointer = cylinder {
    <0,0.25,0>, <0.001,0.25,0>, 0.0001
    open
    texture{
       pigment{ Red }
    }
...
//------------------------------------------------
// z-axis pointer:
#declare MyZPointer = cylinder {
    <0,0.25,0>, <0.0,0.25,0.001>, 0.0001
    open
    texture{
       pigment{ Blue }
    }
